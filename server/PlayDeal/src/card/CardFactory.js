...
module.exports = class CardFactory {
    make(cardKey) {
        ...
        switch (cardKey) {
            case "DRAW_CARDS":
                ...
                card.setKey(cardKey);
                card.setValue(3);
                card.addTags([Card.TAG_DRAW, Card.TAG_BANKABLE]);
            ...
            case "NOPE":
                ...
                /*
          card.setFunction('activate', new ContestableCardFunction(playSelection))
        */
    ...
    _makeCashCard(value) {
        ...
        card.setValue(value);
        card.addTags([Card.TAG_BANKABLE, Card.TAG_CASH]);
        return card;
    }
